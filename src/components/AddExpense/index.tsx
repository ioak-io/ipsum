...
import { IPSUM_PREF_ADDEXPENSE_ANOTHER } from '../../constants/SessionStorageConstants';
...
const AddExpense = (props: Props) => {
  ...
  useEffect(() => {
    ...
    if (sessionStorage.getItem(IPSUM_PREF_ADDEXPENSE_ANOTHER)) {
      setAddAnother(
        sessionStorage.getItem(IPSUM_PREF_ADDEXPENSE_ANOTHER) === 'true'
      );
    }
  }, []);
